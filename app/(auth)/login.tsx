    ...
    <SafeAreaView style={GLOBAL_STYLES.container}>
      ...
      >
        <View style={styles.header}>
          <Text style={styles.logo}>RE<Text style={{color: COLORS.primary}}>activate</Text></Text>
          <Text style={styles.subtitle}>Gestión de Bienestar y Entrenamiento</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  logo: { fontSize: 40, fontWeight: '900', color: COLORS.secondary, letterSpacing: -1 },
